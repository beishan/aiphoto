...
const dockPreviewStyle = computed(() => ({
  ...
  '--preview-padding': `${dock.value.iconPadding}px`,
  ...
  <div class="theme-settings">
    ...
    <section v-if="activeTab === 'style'" class="settings-section">
      ...
      <div class="style-grid">
        <el-button v-for="item in themes" :key="item.id" class="style-card" :class="[`preview-${item.id}`, { active: theme === item.id }]" @click="selectTheme(item.id)">
      ...
      <div class="color-layout">
        ...
        <div class="color-controls">
          ...
          <div class="accent-presets">
            <el-button v-for="preset in accentPresets" :key="preset.color" :class="{ active: accent === preset.color }" @click="updateAccent(preset.color)">
    ...
    <section v-else-if="activeTab === 'background'" class="settings-section">
      ...
      <div class="background-presets">
        <el-button v-for="preset in currentBackgroundPresets" :key="preset.name" :class="{ active: JSON.stringify(background) === JSON.stringify(preset.value) }" @click="applyBackgroundPreset(preset.value)">
