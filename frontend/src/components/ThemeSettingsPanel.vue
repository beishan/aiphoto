    ...
    <section v-else class="settings-section">
      ...
      <div class="dock-layout">
        ...
        <div class="dock-controls">
          ...
          <label class="range-control"><span><b>图标大小</b><output>{{ dock.iconSize }} px</output></span><small>可单独放大图标，不改变玻璃托盘和图标间距。</small><el-slider :model-value="dock.iconSize" :min="16" :max="60" :show-tooltip="false" @input="(value: number | number[]) => updateDock('iconSize', sliderValue(value))" /></label>
