...
<template>
  <div class="album-detail">
    ...
    <div class="detail-header">
      ...
      <el-button v-if="album?.type === 'TRAINING'" class="train-btn" type="primary" plain round @click="handleTrain">
        训练
      </el-button>
      <el-button v-if="photos.length > 0" class="cover-btn" round :type="pickingCover ? 'primary' : 'default'" @click="pickingCover = !pickingCover">
    ...
    <div class="description-section">
      <div v-if="editingDescription" class="description-edit">
        ...
        <div class="description-actions">
          <el-button round @click="cancelEditDescription">取消</el-button>
          <el-button type="primary" round @click="saveDescription">保存</el-button>
        </div>
      </div>
    ...
    <el-empty v-else-if="photos.length === 0" class="empty-state" description="相册中暂无照片" :image-size="92" />
