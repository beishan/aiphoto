...
import com.aiphoto.repository.CategoryRepository;
import com.aiphoto.repository.FaceClusterRepository;
...
public class PhotoService {
    ...
    public PhotoDTO uploadPhoto(MultipartFile file, Long userId) throws Exception {
        ...
        photoIndexingService.indexPhotos(aiTask.getId(), List.of(photo.getId()));
    ...
    @Transactional
    public int restoreTrashByIds(List<Long> ids) {
