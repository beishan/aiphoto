...
import com.aiphoto.dto.DockConfigDTO;
import com.aiphoto.dto.UserDTO;
import com.aiphoto.dto.UserProfileUpdateRequest;
import com.aiphoto.entity.User;
import com.aiphoto.repository.UserRepository;
import com.aiphoto.security.JwtService;
...
public class UserService implements UserDetailsService {
    ...
    public UserDTO updateCurrentDockConfig(String username, DockConfigDTO config) {
        ...
        user.setDockIconGap(config.getIconGap());
    ...
    private void validateDockConfig(DockConfigDTO config) {
        if (config == null
                ...
                || config.getIconGap() == null || config.getIconGap() < 2 || config.getIconGap() > 20
    ...
    private UserDTO toDTO(User user) {
        ...
        if (user.getDockOpacity() != null) {
            ...
            dockConfig.setIconGap(user.getDockIconGap() == null ? 11 : user.getDockIconGap());
